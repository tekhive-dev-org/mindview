export const QUOTE_SERVICE_OPTIONS = [
	...
	{ value: "vertical-transport", label: "Vertical Transport & Access" },
	{ value: "energy", label: "Energy Solutions" },
	{ value: "integration", label: "Consultancy & Integration" },
];
...
export function validateQuoteRequest(input) {
	...
	if (!data.consent) {
		errors.consent = "You must confirm that Mindview can contact you about this request.";
	}
