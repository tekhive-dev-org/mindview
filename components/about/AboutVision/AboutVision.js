					...
					<div className={styles.textCol}>
						<div className={styles.block}>
							...
							<p className={styles.blockText}>
								We envision a world where geographical boundaries are mere lines on
								a map, where teams seamlessly come together to innovate, create, and
								conquer.
							</p>
							<p className={styles.blockText}>
								Our vision is to become the go-to platform where aspiring
								professionals, startups, and organizations access world-class
								training, mentorship, and technology services that drive growth and
								innovation.
							</p>
						</div>
						...
						<div className={styles.block}>
							...
							<p className={styles.blockText}>
								...
								learning and industry by empowering individuals and organizations
								with practical tech skills, transformative digital solutions, and
