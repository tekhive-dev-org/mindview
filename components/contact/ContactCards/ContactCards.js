...
const CARDS = [
	...
	},
	{
		icon: (
			<svg viewBox="0 0 24 24" fill="currentColor" className={styles.cardSvg}>
				<path d="M20 4H4a2 2 0 00-2 2v12a2 2 0 002 2h16a2 2 0 002-2V6a2 2 0 00-2-2zm0 2v.01L12 11 4 6.01V6h16zM4 18V8.236l7.445 4.653a1 1 0 001.11 0L20 8.236V18H4z" />
			</svg>
		),
		title: "Email us",
		desc: "Share project details and our team will respond directly.",
		action: "mindviewauto@gmail.com",
		href: "mailto:mindviewauto@gmail.com",
	},
	{
		icon: (
			<svg viewBox="0 0 24 24" fill="currentColor" className={styles.cardSvg}>
